...
describe('NotificationsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RouterTestingModule, OverlayModule, CoreModule, BrowserAnimationsModule],
      declarations: [ NotificationsComponent, WordingComponent ],
